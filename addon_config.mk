...
meta:
	ADDON_NAME = ofxSwipeVectors
	ADDON_DESCRIPTION = getting swipe vectors for touch
	ADDON_AUTHOR = dasoe
	ADDON_TAGS = "swipe" "touch" "gestures"
	ADDON_URL = http://github.com/dasoe/ofxSwipeVectors
	ADDON_PLATFORMS = vs
